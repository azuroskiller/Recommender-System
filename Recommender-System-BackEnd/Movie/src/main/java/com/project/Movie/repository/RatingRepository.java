...
public class RatingRepository {
    ...
    private String prefixSQL ="SELECT MOVIEID, ROUND(AVG(RATING),1) as AVG_RATING FROM HAIRUL_RATINGS \n" +
            "WHERE MOVIEID = ";
    ...
    public List<Rating>findAll(){
        return jdbcTemplate.query("Select * from HAIRUL_RATINGS WHERE ROWNUM <= 5 ", rowMapper);
    }
