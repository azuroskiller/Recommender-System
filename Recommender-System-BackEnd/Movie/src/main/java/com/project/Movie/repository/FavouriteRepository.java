...
public class FavouriteRepository {
    ...
    public boolean addFav(Favourite f){
        ...
        String sql = "INSERT INTO HAIRUL_FAV_MOVIES (USERID, MOVIEID) VALUES (?, ?)";
    ...
    public boolean removeFav(Favourite f){
        ...
        String sql = "DELETE FROM HAIRUL_FAV_MOVIES WHERE USERID = ? AND MOVIEID = ?";
    ...
    public List<Favourite> getAll(){
        return jdbcTemplate.query("Select * from HAIRUL_FAV_MOVIES", rowMapper);
    }

    //Method to get all fav movies of the user by passing the userID
    public List<Favourite> getByID(int id){
        return jdbcTemplate.query("Select * from HAIRUL_FAV_MOVIES WHERE USERID = "+id, rowMapper);
    }
