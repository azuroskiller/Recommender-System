...
public class MatrixRepo {
    ...
    private String prefixSQL = "SELECT * FROM HAIRUL_MOVIES \n" +
            "    WHERE MOVIEID IN (SELECT MOVIE_ID FROM HAIRUL_SIM_MATRIX WHERE ";
    ...
    private String SQL ="SELECT * FROM HAIRUL_MOVIES \n" +
            "    WHERE MOVIEID IN (SELECT MOVIE_ID FROM HAIRUL_SIM_MATRIX WHERE ID_1 > 0.6 AND MOVIE_ID <> ) ";
